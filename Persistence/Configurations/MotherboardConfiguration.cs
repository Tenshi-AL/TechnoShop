...
public class MotherboardConfiguration: IEntityTypeConfiguration<Motherboard>
{
    public void Configure(EntityTypeBuilder<Motherboard> builder)
    {
        ...
        builder.Property(m => m.MotherboardPower).HasMaxLength(20);
        builder.Property(m => m.CPU_Power).HasMaxLength(20);
        ...
        builder.Property(m => m.OnboardUSB3_2Gen2).HasMaxLength(20);
        builder.Property(m => m.OnboardUSB3_2Gen1).HasMaxLength(20);
        builder.Property(m => m.OnboardUSB2_0).HasMaxLength(20);

        builder.Property(m => m.FormFactor).HasMaxLength(20);
        builder.Property(m => m.RAIDSupport).HasMaxLength(20);
        builder.Property(m => m.WiFiAdapter).HasMaxLength(50);
        builder.Property(m => m.BluetoothAdapter).HasMaxLength(20);
